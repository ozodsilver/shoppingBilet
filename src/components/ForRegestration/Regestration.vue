<template>
            ...
            <div class="row g-0">
              ...
              <div class="col-md-8">
                <div class="card-body">
                  ...
                  <button
                    class="btn w-100 btn-warning bg-gradient"
  ...
  <text x="110" y="130" font-size="16" font-family="Arial" fill="#fff">Tooltip text</text> -->
                ...
                <path
                  @click="addSectorId(10, 'Sector 11')"
                  id="p11"
                  class="cls-4"
                ...
                <path
                  @click="addSectorId(11, 'Sector 12')"
                  id="p12"
                  class="cls-4"
                ...
                <path
                  @click="addSectorId(12, 'Sector 13')"
                  id="p13"
                  class="cls-4"
                ...
                <path
                  @click="addSectorId(13, 'Sector 14')"
                  id="p14"
                  class="cls-4"
                ...
                <path
                  @click="addSectorId(14, 'Sector 15')"
                  id="p15"
                  class="cls-4"
                ...
                <path
                  @click="addSectorId(15, 'Sector 16')"
                  id="p16"
                  class="cls-4"
                ...
                <path
                  @click="addSectorId(16, 'Sector 17')"
                  id="p17"
                  class="cls-4"
                ...
                <path
                  @click="addSectorId(17, 'Sector 18')"
                  id="p18"
                  class="cls-4"
                ...
                <path
                  @click="addSectorId(18, 'Sector 19')"
                  id="p19"
                  class="cls-4"
                ...
                <path
                  @click="addSectorId(19, 'Sector 20')"
                  id="p20"
                  class="cls-4"
                ...
                <path
                  @click="addSectorId(20, 'Sector 21')"
                  id="p21"
                  class="cls-4"
