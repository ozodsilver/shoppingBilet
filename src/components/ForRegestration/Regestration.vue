...
<!-- modal -->
  ...
  <text x="110" y="130" font-size="16" font-family="Arial" fill="#fff">Tooltip text</text> -->
                ...
                ></path>
                <text x="400" transform="translate(-20,-30)"  @click="addSectorId(2,'Sector 2')">
                ...
                />
                <text x="400" transform="translate(10,-30)"  @click="addSectorId(3,'Sector 3')">
                ...
                />
                <text x="400" transform="translate(35,-30)"  @click="addSectorId(4,'Sector 4')">
                ...
                />
                <text x="300" transform="translate(0,-30)"  @click="addSectorId(5,'Sector 5')">
                ...
                />
                <text x="0" transform="translate(30,-30)"   @click="addSectorId(6,'Sector 6')">
                ...
                />
                <text x="200" transform="translate(50,1)"    @click="addSectorId(8,'Sector 8')">
                ...
                />
                <text x="10" transform="translate(50,-20)"   @click="addSectorId(9,'Sector 9')">
                ...
                />
                <text x="35" transform="translate(70,-40)"  @click="addSectorId(10,'Sector 10')">
                ...
                />
                <text x="280" transform="translate(10,-40)"  @click="addSectorId(11,'Sector 11')">
                ...
                />
                <text x="130" transform="translate(10,-30)"  @click="addSectorId(12,'Sector 12')">
                ...
                />
                <text x="120" transform="translate(0,-30)"  @click="addSectorId(13,'Sector 13')">
                ...
                />
                <text x="340" transform="translate(0,-30)"   @click="addSectorId(14,'Sector 14')">
                ...
                />
                <text x="0" transform="translate(20,-30)"    @click="addSectorId(15,'Sector 15')">
                ...
                />
                <text x="230" transform="translate(20,-30)"   @click="addSectorId(16,'Sector 16')">
                ...
                />
                <text x="180" transform="translate(20,-30)"   @click="addSectorId(17,'Sector 17')">
                ...
                />
                <text x="210" transform="translate(20,-30)" @click="addSectorId(18,'Sector 18')">
                ...
                />
                <text x="360" transform="translate(20,-30)"   @click="addSectorId(19,'Sector 19')">
                ...
                />
                <text x="330" transform="translate(20,-30)"   @click="addSectorId(20,'Sector 20')">
                ...
                />
                <text x="370" transform="translate(20,-40)" @click="addSectorId(21,'Sector 21')">
