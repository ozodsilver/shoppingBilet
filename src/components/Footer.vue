    ...
    <div class="row">
        <div class="col-6 col-lg">
            <div class="pb-10">
                ...
                <div class="d-flex flex-column font-size-3 font-weight-bold">
                                                                        <a href="" class="text-dark-60 text-hover-primary py-2 py-lg-3">Pro Templates</a>
                                                    <a href="" class="text-dark-60 text-hover-primary py-2 py-lg-3">Free Templates</a>
                                                    <a href="" class="text-dark-60 text-hover-primary py-2 py-lg-3">Developer6669</a>
                                                            </div>
            </div>
        </div>
        ...
        <div class="col-6 col-lg">
            <div class="pb-10">
                ...
                <div class="d-flex flex-column font-size-3 font-weight-bold">
                                            <a href="" class="text-dark-60 text-hover-primary py-2 py-lg-3">All Tutorials</a>
            ...
            <div class="pb-10">
                ...
                <div class="d-flex flex-column font-size-3 font-weight-bold">
                            ...
                            Facebook
                                            ...
                                            <a href="" class="d-flex align-items-center text-center text-dark-60 text-hover-primary py-2 py-lg-3">
                            <img src="/Projects/assets/images/icons/social-media/twitter.svg" data-lazy-src="/Projects/assets/images/icons/social-media/twitter.svg" class="w-20px mr-4 loaded" alt="">
                            Twitter
                        </a>
                                            <a href="" class="d-flex align-items-center text-center text-dark-60 text-hover-primary py-2 py-lg-3">
                            <img src="/Projects/assets/images/icons/social-media/dribbble.svg" data-lazy-src="/Projects/assets/images/icons/social-media/dribbble.svg" class="w-20px mr-4 loaded" alt="">
                            Dribbble
                        </a>
                                            <a href="" class="d-flex align-items-center text-center text-dark-60 text-hover-primary py-2 py-lg-3">
                            <img src="/Projects/assets/images/icons/social-media/instagram.svg" class="w-20px mr-4 loaded"  data-lazy-src="/Projects/assets/images/icons/social-media/instagram.svg" alt="">
                            Instagram
                        </a>
                                            <a href="" class="d-flex align-items-center text-center text-dark-60 text-hover-primary py-2 py-lg-3">
    ...
    <div class="d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-between">
        <div class="d-flex align-items-center mr-md-2 order-2 order-md-1">
            ...
            <span class="font-size-2 font-weight-bold text-dark-60 pt-1" href="">
                © 2023  ozodsilver@gmail.com
            </span>

        </div>

        <div class="d-flex flex-column flex-md-row align-items-center justify-content-center order-1 order-md-2 mb-5 mb-md-0">
